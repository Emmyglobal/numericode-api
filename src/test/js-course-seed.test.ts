...
import { module01 } from '../db/js-course/module-01'
import { module02 } from '../db/js-course/module-02'
import { module03 } from '../db/js-course/module-03'
import { module04 } from '../db/js-course/module-04'
import { module05 } from '../db/js-course/module-05'
import { module06 } from '../db/js-course/module-06'
import type { ModuleData } from '../db/js-course/types'
...
describe('JavaScript course — seed data integrity', () => {
  it('registers at least one module with titled lessons', () => {
    expect(JS_MODULES.length).toBeGreaterThan(0)
