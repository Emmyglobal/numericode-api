...
- Area of segment = Area of sector − Area of triangle.`,
      quiz: {
        ...
        questions: [
          ...
          { id: 'q4', questionText: 'The area of a sector with radius 7 cm and angle 90 degrees (take pi = 22/7):', questionType: 'fill_blank', correctAnswer: 77, explanation: '(90/360) x (22/7) x 49 = 38.5' },
