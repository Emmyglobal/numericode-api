...
const courses: CourseSeed[] = [
  ...
  { title: 'HTML & CSS Fundamentals', subject: 'programming', description: 'A hands-on introduction to building web pages with HTML5 and styling them with modern CSS — from structure and semantics to layout, colour, and accessibility.', modules: [
    ['HTML Foundations', ['What is HTML and the Web', 'HTML Boilerplate and Doctype', 'Elements, Tags, Attributes, and Nesting']],
    ['Text, Links and Media', ['Headings, Paragraphs, and Text Formatting', 'Links, Anchors and URLs', 'Images, Alt Text, and Media']],
    ['Lists, Tables and Structure', ['Ordered, Unordered and Description Lists', 'Tables: rows, headers and structure', 'Divs, Spans and the Box Model']],
    ['CSS Foundations', ['The Cascade and Selectors', 'Colours, Units and Web Fonts', 'Comments and Organising CSS']],
    ['Layout and Visuals', ['Box Model: margin, border, padding', 'Flexbox Layout', 'CSS Grid Layout']],
    ['Polish and Practice', ['Responsive Images and Media Queries', 'Forms and Inputs Styling', 'Final Project: Personal Profile Page']],
  ] },
